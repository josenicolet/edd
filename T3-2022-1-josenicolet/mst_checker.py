...
def check_improvement(graph, jsonfile, testfile, cost):
    ...
    elif (suma/comparador[key]["obj"]) > 1.20:
...
if __name__ == '__main__':
    list_path = ["TESTS_T3/P1/easy_0.txt", "TESTS_T3/P1/easy_1.txt", "TESTS_T3/P1/easy_2.txt", "TESTS_T3/P1/medium_0.txt",
                 "TESTS_T3/P1/medium_1.txt", "TESTS_T3/P1/medium_2.txt", "TESTS_T3/P1/hard_0.txt", "TESTS_T3/P1/hard_1.txt", "TESTS_T3/P1/hard_2.txt"]
    jsonfiles = "TESTS_T3/P1/sewerrat.json"
    output_file_path = "output.txt"
    for path in list_path:
        os.system(f"./sewerrat {path} output.txt")
        _, score = check_mst(path, output_file_path, jsonfiles)
